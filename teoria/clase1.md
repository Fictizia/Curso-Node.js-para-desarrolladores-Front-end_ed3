...
**3 -** Presentate en este [issue](https://github.com/Fictizia/Curso-Node.js-para-desarrolladores-Front-end_ed3/issues/1)
...
- **[Curratelo](http://curratelo.herokuapp.com/)**
 - Automatización de tareas
 - Scraping sistematico
 - Conversión y hegemonización de los datos en bruto
 - Modularidad entorno a las posibles fuentes de datos y filtrado
 - Arquitectura alternativa
 - BackEnd basado en ChatBot
 - Comunicación automatizada con Google Hangouts y Slack
